...
class mutall_mailer extends PHPMailer {
    ...
    private function server_config() {
        ...
        $this->Username = "smithsaruni16@gmail.com";
        //
        //Set the server password.
        $this->Password = 'bsav pgpr vcdw ouad';
        //
    ...
    private function set_source_addresses() {
        ...
        //the sender of the email.i.e. ("smithsaruni16@gmail.com","MUTALL DATA")
        $this->setFrom("smithsaruni16@gmail.com", "MUTALL DATA");
        //
        //Set the email to reply to. The email and the reply keyword are the two
        // parameters in this section
        $this->addReplyTo("smithsaruni16@gmail.com", "Reply");
        //
