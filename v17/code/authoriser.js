...
import { baby } from "../../../outlook/v/code/outlook.js";
...
export class authoriser extends baby {
    mother;
    user;
    //
    ...
    async set_up_launch_button(css) {
        //
        // Get the button to launch the authoriser
        const launch = document.querySelector(css);
        if (!launch)
            return;
        //
