...
export class auth extends view {
  ...
  // Check the user credentials and return them if they are valid
  // otherwise,return undefined. Both the check and
  // collection of credentials depend on the selected operation
  //
  //collect the inputs
  //#get_inputs():credentials | udefined
  //
  //check the credentials
  //#check_inputs(credentials):boolean
  //
  //return credentials
  #get_credentials(): credentials | undefined {
    ...
    const choice = radio_choice.value as operation_id;
    //
    ...
    if (!this.#validate_required_fields(field_set)) return undefined;
    //
...
interface credentials {
  ...
  //
  //name of the user is required by all operations
  name: string;
  //
  //email is required during registration and forget password operations
  email?: string;
  //
  //Only forgot password operation does not require the password
  password?: string;
  //
  //confirm password
  //
  //required when changing the users password
  new_password?: string;
}
