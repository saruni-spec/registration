...
export class auth extends view {
    ...
    #set_error_message(selector, errorMessage) {
        //
        // Find the error span associated with the input
        const errorSpan = this.query_selector(`${selector} span.error`);
        //
    ...
    input_not_empty(selector, errorMessage = "This field is required") {
        //
        // Get the input element using the provided selector
        const input = this.query_selector(`${selector} input`);
        //
    ...
    #password_match(passwordSelector, confirmPasswordSelector, errorMessage = "Passwords do not match") {
        //
        // Get the password and confirm password input fields
        const password = (this.query_selector(`${passwordSelector} input[type="password"]`));
        const confirm_password = (this.query_selector(`${confirmPasswordSelector} input[type="password"]`));
    ...
    #check_change() {
        ...
        return this.#password_match("#change_new_password", "#change_confirm_password");
    }
    //
