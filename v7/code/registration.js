...
export class auth extends view {
    ...
    set_error_message(field_id, error_message) {
        ...
        let error_span = document.querySelector(`${field_id} span.error`);
        //
    ...
    #input_empty(field_value, field_id) {
        //
    ...
    #check_change(credentials) {
        ...
        if (credentials.confirm_password === "") {
            //
            // If empty, display an error message
            this.set_error_message("#change_confirm_password", "This field is required");
            return false;
        }
        //
